                ...
                <div className='fixed inset-0 overflow-y-auto'>
                    <div className='flex min-h-full items-center justify-center p-4 text-center'>
                        <Transition.Child
                            ...
                            leave='ease-in duration-200'
                            leaveFrom='opacity-110 scale-100'
                             ...
                             <Dialog.Panel className='relative w-full max-w-lg max-h-[90vh] overflow-y-hidden transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5'>
                                ...
                                <div className='flex-1 flex flex-col gap-3'>
                                    <div className='relative w-full h-40 bg-pattern bg-cover bg-center rounded-lg'>
                                      <Image src='/hero.png' fill   alt='modelo do carro'  priority className='object-contain'/>
                                    </div>
                                ...
                                <div className='flex-1 flex flex-col gap-2'>
                                  ...
                                  <div className='mt-3 flex flex-wrap gap-4'>
                                    {Object.entries(car).map(([key,value]) =>(
                                        <div className='flex justify-between ga-5 w-full text-right' key={key}>
